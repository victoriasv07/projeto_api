...
def tres_maiores(data, n=3):
    tres_salarios = sorted(data, key=lambda x: x['salario'], reverse=True)
    return tres_salarios[:n]
...
def sexo_idade(data):
    ...
    return [count_feminino, count_masculino, intervalo_idades, sexo_maior_2000]